...
reaFormatted <- def.format.reaeration(dataDir = dataDir)
...
reaRatesCalc <- def.calc.reaeration(inputFile = reaFormatted, dataDir = dataDir, plot = T)

setwd("C:/Users/kcawley/Documents/GitHub/biogeochemistryIPT/reaeration/Science Only/rCodeForRelease/reaRate")
