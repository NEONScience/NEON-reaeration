##############################################################################################
#' @title KING Multilevel model for estimate gas exchange in streams
...
load(paste0(localPath,siteID,"/KING_workspace.RData"))
...
badExperiments.clean <- c("KING.20190510","KING.20190522")
#' These two have negative gas loss rates

badExperiments.salt <- c("KING.20160706")
#' Large background salt outlier at station 4 (large plateau outlier at station 4 also removed)
